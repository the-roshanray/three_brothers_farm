        ...
        <section className="overflow-hidden rounded-[40px] bg-white shadow-[0_20px_60px_rgba(120,63,15,0.12)] transition-shadow hover:shadow-[0_30px_80px_rgba(120,63,15,0.18)]">
          <div className="grid items-center gap-8 p-8 lg:grid-cols-[1.1fr_0.9fr] lg:p-14">
            ...
            <div>
              ...
              <div className="mt-8 rounded-2xl bg-gradient-to-br from-stone-50 to-stone-100/80 p-6 shadow-inner">
                <div className="flex flex-col gap-5">
                  {/* Header */}
                  <div className="flex items-center gap-2">
                    <span className="text-xl">🌱</span>
                    <p className="text-sm font-medium text-stone-600">
                      Order from our social channels:
                    </p>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group inline-flex items-center gap-2.5 rounded-full bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 px-5 py-3 text-sm font-semibold text-white shadow-md transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-pink-500/30"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
                      ...
                      <span className="text-xs opacity-70 transition group-hover:translate-x-0.5">
                        →
                      </span>
                    </a>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-5 py-3 text-sm font-semibold text-white shadow-md transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#25D366]/30"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
                    ...
                    {/* Email */}
                    <a
                      href="mailto:info@threebrothersfarm.in"
                      className="group inline-flex items-center gap-2.5 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-3 text-sm font-semibold text-white shadow-md transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/30"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
